...
def complete_symbol_payload(
    ...
    payload["hard_blockers"] = list(gate.get("hard_blockers", []))
    payload["soft_warnings"] = list(gate.get("soft_warnings", []))
    payload["blocker_categories"] = gate.get("blocker_categories", {})
    payload["execution_status"] = gate.get("execution_status")
    payload["execution_status_label"] = gate.get("execution_status_label")
    payload["gate_version"] = gate.get("gate_version")
    payload["entry_origin"] = gate.get("entry_origin", getattr(side, "entry_origin", "unknown"))
    payload["entry_validity"] = gate.get("entry_validity", getattr(side, "entry_validity", "unknown"))
