...
def trading_standard_profile(symbol: str) -> TradingStandardProfile:
    ...
    if kind == "core_crypto":
        return TradingStandardProfile(
            instrument_class=kind,
            min_score_gap=6.0,
            min_htf_context=55.0,
            min_ltf_trigger=62.0,
            ...
            limit_min_execution_score=58.0,
            limit_min_setup_score=68.0,
    ...
    return TradingStandardProfile(
        ...
        limit_min_selection_score=73.0,
        limit_min_execution_score=55.0,
        limit_min_setup_score=66.0,
