...
def trading_standard_profile(symbol: str) -> TradingStandardProfile:
    ...
    if kind == "non_crypto_proxy":
        return TradingStandardProfile(
            ...
            market_min_execution_score=84.0,
    ...
    if kind == "large_altcoin":
        return TradingStandardProfile(
            instrument_class=kind,
            min_score_gap=7.5,
            min_htf_context=57.0,
            min_ltf_trigger=61.0,
            min_entry_quality=57.0,
            min_risk_quality=58.0,
            min_rr=1.55,
            scalp_min_rr=1.35,
            strict_min_rr=1.90,
            max_entry_distance_pct=0.42,
            max_entry_band_pct=1.15,
            min_core_data_quality=58.0,
            min_derivatives_context=53.0,
            limit_min_selection_score=70.0,
            limit_min_execution_score=60.0,
            limit_min_setup_score=70.0,
            limit_min_ltf_trigger=52.0,
            limit_min_entry_quality=50.0,
            market_min_execution_score=80.0,
            funding_warm=0.00018,
            funding_elevated=0.00045,
            funding_extreme=0.00095,
            oi_hot_change_pct=24.0,
            oi_extreme_change_pct=45.0,
            crowding_block_score=84.0,
            exhaustion_block_score=84.0,
        )
    return TradingStandardProfile(
        instrument_class=kind,
        min_score_gap=7.0,
        min_htf_context=54.0,
        min_ltf_trigger=58.0,
        min_entry_quality=52.0,
        min_risk_quality=55.0,
        min_rr=1.45,
        scalp_min_rr=1.35,
        strict_min_rr=1.95,
        max_entry_distance_pct=0.55,
        max_entry_band_pct=1.45,
        min_core_data_quality=52.0,
        min_derivatives_context=52.0,
        limit_min_selection_score=66.0,
        limit_min_execution_score=56.0,
        limit_min_setup_score=66.0,
        limit_min_ltf_trigger=48.0,
        limit_min_entry_quality=48.0,
        market_min_execution_score=78.0,
        funding_warm=0.00025,
        funding_elevated=0.00060,
        funding_extreme=0.00100,
        oi_hot_change_pct=30.0,
        oi_extreme_change_pct=55.0,
        crowding_block_score=86.0,
        exhaustion_block_score=86.0,
    )
