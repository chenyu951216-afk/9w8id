...
def _mode_decision_model(
    ...
    if direction_conviction < 48.0:
        hard_blockers.append("ETH direction conviction is too weak; long/short edge has not separated enough.")
    elif direction_conviction < 52.0:
        soft_notes.append("ETH direction conviction is still borderline; allow only planned-zone execution, not chase.")
    ...
    return {
        ...
        "checks": {
            "direction_ready": direction_conviction >= 48.0,
