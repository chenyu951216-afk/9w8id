...
def evaluate_execution_gate(report: SymbolReport) -> dict[str, Any]:
    ...
    limit_checks = {
        **common_checks,
        ...
        "limit_behavior_quality": bool(diag.get("market_behavior_ok", True)),
    }
    ...
    normal_limit_ready = all(value for key, value in limit_checks.items() if key != "external_derivatives")
