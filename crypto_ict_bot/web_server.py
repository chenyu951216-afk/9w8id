...
from .gate_executor import attach_gate_execution, check_gate_connection, manage_gate_position
    ...
    def start_gate_monitor_due(self) -> bool:
        with self.lock:
            ...
            if self.gate_monitor_running:
                return False
            poll_seconds = max(3, min(60, int(gate.get("position_poll_seconds") or 10)))
